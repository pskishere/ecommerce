...
function renderOrderChart() {
  ...
  orderChart.setOption({
    color: ['#52667f', '#7f91a8', '#9b7a48', '#6f8192', '#cbd5e1'],
...
function renderSalesChart() {
  ...
  salesChart.setOption({
    ...
    yAxis: [
      { type: 'value', name: 'GMV', axisLabel: { formatter: value => `${value}` }, splitLine: { lineStyle: { color: '#e9edf2' } } },
    ...
    series: [
      {
        ...
        type: 'line',
        smooth: true,
        areaStyle: { color: 'rgba(82, 102, 127, 0.1)' },
