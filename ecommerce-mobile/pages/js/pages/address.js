  ...
  list.innerHTML = addrList.map(addr => `
    <div class="address-card ${addr.isDefault ? 'default' : ''}">
      ...
      <div class="address-card-footer">
        <button class="address-default-btn ${addr.isDefault ? 'active' : ''}" onclick="event.stopPropagation();setDefault('${String(addr.id).replace(/'/g, "\\'")}')">
        ...
        <div class="address-actions">
          ...
          <button class="address-del-btn" onclick="event.stopPropagation();deleteAddress('${String(addr.id).replace(/'/g, "\\'")}')">
